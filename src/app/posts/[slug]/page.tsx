    ...
    return (
        <article className="space-y-8">
            <header className="space-y-3">
                <p className="text-xs font-medium uppercase tracking-wide text-foreground/60">{formatDate(post.publishedAt)}</p>
            ...
            <Card className="border-dashed border-foreground/20 bg-muted/60">
                ...
                <CardContent className="flex flex-col gap-2 text-sm text-foreground/75 sm:flex-row sm:items-center sm:justify-between">
                    <span>실제 데이터 연동 시 자동으로 최신 내용이 노출됩니다. 초안/비공개 상태는 관리자만 볼 수 있게 처리할 예정입니다.</span>
