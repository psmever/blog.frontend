...
import { editorTagInterface, postRequestInterface } from 'commonTypes';
import { postCreate, postEdit, postPublish, postUpdate, postWaitingList } from 'modules/API';

import { postGetListResetAction } from 'modules/redux/post';
    ...
    useEffect(() => {
        async function getPostData() {
            ...
            if (editResult.status === true) {
                ...
                setEditorTagContents(
                    editResult.payload.tags.map((element: any) => {
                        return {
                            id: element.tag_id,
