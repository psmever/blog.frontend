                    ...
                    <div className="container">
                        <div className="item mb-5">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <h3 className="title mb-1"><Link to="/">Why Every Developer Should Have A Blog</Link></h3>
                        ...
                        <div className="item mb-5">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <h3 className="title mb-1"><Link to="/">A Guide to Becoming a Full-Stack Developer</Link></h3>
                        ...
                        <div className="item mb-5">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <h3 className="title mb-1"><Link to="/">High Performance JavaScript</Link></h3>
                        ...
                        <div className="item mb-5">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <h3 className="title mb-1"><Link to="/">Top 5 JavaScript Frameworks</Link></h3>
                        ...
                        <div className="item mb-5">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <h3 className="title mb-1"><Link to="/">Learn React in 24 Hours</Link></h3>
                        ...
                        <div className="item">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    <h3 className="title mb-1"><Link to="/">About Remote Working</Link></h3>
