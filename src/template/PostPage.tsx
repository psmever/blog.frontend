    ...
    return (
        <>
            ...
            <div className="main-wrapper">
                <article className="px-3 py-5 blog-post p-md-5">
                    <div className="container">
                        <header className="blog-post-header">
                            <h2 className="mb-2 title">Why Every Developer Should Have A Blog</h2>
                        ...
                        <div className="blog-post-body">
                            <figure className="blog-banner">
                                <Link to="/">
                                    <img className="img-fluid" src="/assets/images/blog/blog-post-banner.jpg" alt="" />
                                </Link>
                                <figcaption className="mt-2 text-center image-caption">
                                    Image Credit: <Link to="/">made4dev.com (Premium Programming T-shirts)</Link>
                                </figcaption>
                            </figure>
                            <p>
                            ...
                            <p>
                                You can get more info at <Link to="/">https://highlightjs.org/</Link>. Lorem ipsum dolor
                            ...
                            <blockquote className="py-3 pl-4 blockquote m-lg-5 px-lg-5">
                                <p className="mb-2">
                                    You might not think that programmers are artists, but programming is an extremely
                            ...
                            <blockquote className="twitter-tweet" data-lang="en">
                                ...
                                &mdash; I Am Devloper (@iamdevloper) <Link to="/">November 3, 2017</Link>
                            </blockquote>
                        ...
                        <nav className="my-5 blog-nav nav nav-justified">
                            <Link to="/" className="nav-link-prev nav-item nav-link rounded-left">
                                Previous<i className="arrow-prev fas fa-long-arrow-alt-left"></i>
                            </Link>
                            <Link to="/" className="nav-link-next nav-item nav-link rounded-right">
                        ...
                        <div className="blog-comments-section">
                            ...
                            <script>
                                ...
                                INSERT DYNAMIC VALUES FROM YOUR * PLATFORM OR CMS. * * LEARN WHY DEFINING THESE
                                VARIABLES IS IMPORTANT: *
                                https://disqus.com/admin/universalcode/#configuration-variables */ /* var disqus_config
                                = function (){' '}
                                {
                ...
                <section className="py-5 text-center promo-section theme-bg-light">
                    <div className="container">
                        ...
                        <figure className="promo-figure">
                            <Link to="/">
                                <img className="img-fluid" src="/assets/images/promo-banner.jpg" alt="" />
                            </Link>
                        </figure>
                    </div>
                    {/* <!--//container--> */}
