    ...
    return (
        <>
            ...
            <div className="main-wrapper">
                <article className="py-5 about-section">
                    <div className="container">
                        <h2 className="mb-3 title">About Me</h2>
                        ...
                        <figure>
                            <img className="img-fluid" src="/assets/images/about-me.jpg" alt="" />
                        </figure>
                        ...
                        <p>
                            ...
                            quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum.
