...
export const baseSagaReducer = createReducer<_commonTypes_.baseSagaState>(initialState, {
    ...
    [Types.BASE_SUCCESS]: (state: _commonTypes_.baseSagaState, action: _commonTypes_.Action<Types, _commonTypes_.baseSagaState>) => {
        return {
            ...state,
            status: "success",
        };
    },
    [Types.BASE_ERROR]: (state: _commonTypes_.baseSagaState, action: _commonTypes_.Action<Types, _commonTypes_.baseSagaState>) => {
        return {
            ...state,
            status: "failure",
        };
