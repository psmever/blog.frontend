...
}): Promise<axiosReturnInterface<apiPostCreateResultInterface>> {
...
export function getPostList({
    ...
    pageNumber: number;
}): Promise<axiosReturnInterface<apiPostListResultInterface>> {
...
export const getPostDetail = ({
    ...
    slugTitle: string;
}): Promise<axiosReturnInterface<apiPostDetailResultInterface>> => {
...
): Promise<axiosReturnInterface<apiPostListResultItemsInterface[]>> => {
