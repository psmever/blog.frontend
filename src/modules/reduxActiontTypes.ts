export enum SagaTypes {
    ...
    // 로그아웃
    LOGOUT_REQUEST_START = 'login/LOGOUT_REQUEST_START',
    LOGOUT_REQUEST_SUCCESS = 'login/LOGOUT_REQUEST_SUCCESS',
    LOGOUT_REQUEST_ERROR = 'login/LOGOUT_REQUEST_ERROR',
    LOGOUT_REQUEST_RESET = 'login/LOGOUT_REQUEST_RESET',
